...
class boylestad_10_1:
    def __init__(self,*args,**kwargs): 
        ...
        self.question = f"""Determine the values of IE, IC and VC for a BJT differential amplifier with RC1 = RC2 = {rc.kohms} ohms, common RE = {re.kohms} kohms, VCC = {vcc.V} V and VEE = {vee.V} V."""
...
class boylestad_10_2:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Output voltage = {vo.V} V"""
...
class boylestad_10_3:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Common-mode gain = {ac}"""
...
class boylestad_10_8:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Output offset voltage = {voo.mV} mV"""
...
class boylestad_10_9:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Output offset voltage = {vo.mV} mV"""
...
class boylestad_10_10:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Total offset voltage = {vo.mV} mV"""
...
class boylestad_10_11:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Input bias currents {iibplus.nA} nA, {iibminus.nA} nA"""
...
class boylestad_10_12:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Cutoff frequency = {fc.Hz} Hz"""
...
class boylestad_10_13:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Closed loop gain =  {acl}"""
...
class boylestad_10_14:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Output signal frequency = {omegaout.radpers} rad/s"""
...
class boylestad_10_15:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Current draw = {current.mA} mA"""
...
class boylestad_10_17:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""CMRR = {CMRR} or {CMRR_log} dB"""
...
class boylestad_11_7:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""The output voltage is {vo.mV} mV"""
...
class boylestad_11_8:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Output voltage = {vo.mV} mV"""
...
class boylestad_11_14:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Lower and Higher cutoff frequencies = {fcl.Hz} Hz, {fch.kHz} kHz"""
