...
class example_2_1:
    def __init__(self,*args,**kwargs):
        velocity = c.velocity(ran.main(0.200), 'cmpers')
...
class example_2_2:
    def __init__(self,*args,**kwargs):
        distance = c.length(  ran.main(200),'m' )
        time = c.time(ran.main(25),'s')
...
class example_2_3:
    def __init__(self,*args,**kwargs):
        acceleration = c.acceleration(ran.main(8.00),'mpers2')
        time = c.time(ran.main(5),'s')
...
class example_2_4:
    def __init__(self,*args,**kwargs):
        velocity1 = c.velocity(ran.main(15),'kmperh')
        velocity2 = c.velocity(ran.main(60),'kmperh')
        time = c.time(ran.main(20),'s')
...
class example_2_9:
    def __init__(self,*args,**kwargs):
        distance = c.length(ran.main(9.0),'m')
        time1 = c.time(ran.main(3.0),'s')
        velocity = c.velocity(ran.main(24),'mpers')
...
class example_2_10:
    def __init__(self,*args,**kwargs):
        velocity = c.velocity(ran.main(20),'mpers')
        deceleration = c.acceleration (ran.main(-3.0),'mpers2')
...
class example_2_11:
    def __init__(self,*args,**kwargs):
        regen = True
        while regen:
            velocityInit = c.velocity(ran.main(30),'mpers')
            velocityFinal = c.velocity(ran.main(10),'mpers')
            timeLarger = c.time(ran.main(5), 's')
...
class example_2_12:
    def __init__(self,*args,**kwargs):
        regen = True
        while regen:
            velocityInit = c.velocity(ran.main(15), 'mpers')
            velocityFinal = c.velocity(ran.main(7), 'mpers')
            distance = c.length(ran.main(90),'m')
...
class example_2_14:
    def __init__(self,*args,**kwargs):
        velocityInit = c.velocity(ran.main(20),'mpers')
        heightCaught = c.length(ran.main(5),'m')
...
class example_2_15:
    def __init__(self,*args,**kwargs):
        ...
        returnTime = c.time(ran.main(4),'s')
...
class example_2_16:
    def __init__(self,*args,**kwargs):
        velocityInitial  = c.velocity(ran.main(35),'mpers')
        gravityMoon = c.acceleration(1.60,'mpers2')
        time = c.time(ran.main(30),'s')
        distanceSpecific = c.length(ran.main(100),'m')
        ...
        timeset = sym.solveset(sym.Eq(distanceSpecific.m, velocityInitial.mpers*x + 0.5*(-gravityMoon.mpers2)*x**2),x,domain = sym.Reals)
...
class example_2_17:
    def __init__(self,*args,**kwargs):
        height = c.length(ran.main(300),'m')
        velocityInitial = c.velocity(ran.main(13),'mpers')
        timeSpecific = c.time(ran.main(5.0),'s')
        ...
        #upward positive:
        equation = sym.Eq(0, velocityInitial.mpers**2 + 2*-gravity.mpers2*x)
        maxHeight = c.length(sym.solveset(equation,x,domain = sym.Reals).args[0])
        ...
        equation = sym.Eq(0, height.m + velocityInitial.mpers*x + 0.5*-gravity.mpers2*x**2)
            
        timeToGround = c.time(max(sym.solveset(equation,x,domain = sym.Reals).args[0], sym.solveset(equation,x,domain = sym.Reals).args[1]))
...
class example_2_18:
    def __init__(self,*args,**kwargs):
        velocityInitialX = c.velocity(ran.main(30),'mpers')
        velocityInitialY = c.velocity(0)
        heightInitial = c.length(ran.main(80),'m')
        ...
        equation = sym.Eq(0, heightInitial.m + velocityInitialY.mpers*x + 0.5*-gravity.mpers2*x**2)
        times = sym.solveset(equation,x,domain = sym.Reals)
...
class example_2_19:
    def __init__(self,*args,**kwargs):
        vix = c.velocity(ran.main(15),'mpers')
        hi = c.length(ran.main(100), 'm')
        viy = c.velocity(0)
        ...
        equation = sym.Eq(0, hi.m + viy.mpers * x + 0.5 * -gravity.mpers2 * x**2)
        
        t = c.time(max(sym.solveset(equation,x,domain = sym.Reals).args[0], sym.solveset(equation,x,domain = sym.Reals).args[1]))
...
class example_2_20:
    def __init__(self,*args,**kwargs):
        vi = c.velocity(ran.main(100),'mpers')
        angle = c.angle(ran.main(30),'deg')
        ...
        equation = sym.Eq(0, viy.mpers + 0.5 * -gravity.mpers2 * x )
        
        
        t = c.time(sym.solveset(equation,x, domain=sym.Reals).args[0])
...
class example_2_21:
    def __init__(self,*args,**kwargs): 
        distanceBuilding = c.length(ran.main(50),'m')
        vi = c.velocity(ran.main(20), 'mpers')
        angle = c.angle(ran.main(40), 'deg')
...
class example_3_2:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(20),'kg')
        force = c.force(ran.main(45), 'N')
...
class example_3_4:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(5),'kg')
        acceleration = c.acceleration(ran.main(0.30),'mpers2')
...
class example_3_5:
    def __init__(self,*args,**kwargs):
        force = c.force(ran.main(140),'N')
        mass = c.mass(ran.main(60), 'kg')
...
class example_3_6:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(50),'kg')
        forceX = c.force(ran.main(20),'N')
        forceY = c.force(ran.main(30),'N')
...
class example_3_7:
    def __init__(self,*args,**kwargs):
        weight = c.force(ran.main(600),'N')
        acceleration = c.acceleration(ran.main(0.70),'mpers2')
...
class example_3_8:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(5), 'kg')
        velocity1 = c.velocity(ran.main(7.0),'mpers')
        velocity2 = c.velocity(7 - ran.main(4.0),'mpers')
        time = c.time(ran.main(3),'s')
...
class example_3_9:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(400),'g')
        velocity1 = c.velocity(ran.main(80),'cmpers')
        friction = c.force(ran.main(0.70),'N')
...
class example_3_10:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(600),'kg')
        velocity1 = c.velocity(ran.main(30),'mpers')
        distanceToStop = c.length(ran.main(70),'m')
...
class example_3_11:
    def __init__(self,*args,**kwargs):
        massEngine = c.mass(ran.main(8000),'kg')
        massTrain1 = c.mass(ran.main(40000),'kg')
        acceleration1 = c.acceleration(ran.main(1.20),'mpers2')
        massTrain2 = c.mass(ran.main(16000),'kg')
...
class example_3_13:
    def __init__(self,*args,**kwargs):
        tensionLimit = c.force(ran.main(1500),'N')
        mass = c.mass(ran.main(700),'kg')
...
class example_3_14:
    def __init__(self,*args,**kwargs):
        regen = True
        while regen:
            mass = c.mass(ran.main(45), 'kg')
            tensionLimit = c.force(min(ran.main(300),mass.kg*gravity.mpers2),'N')
...
class example_3_15:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(70),'kg')
        force = c.force(ran.main(400),'N')
        mu = ran.u(0.5)
...
class example_3_16:
    def __init__(self,*args,**kwargs):
        ...
        while regen:
            mass = c.mass(ran.main(70),'kg')
            force = c.force(ran.main(400),'N')
            angle_force = c.angle(ran.main(30),'deg')
            mu = ran.main(0.5)
...
class example_3_17:
    def __init__(self,*args,**kwargs):
        regen = True
        while regen:
            velocity1 = c.velocity(ran.main(20),'mpers')
...
class example_3_18:
    def __init__(self,*args,**kwargs):
        ...
        while regen:
            force = c.force(ran.main(400),'N')
            theta_force = c.angle(ran.main(50),'deg')
            mass = c.mass(ran.main(25),'kg')
            velocity1 = c.velocity(0)
            velocity2 = c.velocity(ran.main(2), 'mpers')
            time = c.time(ran.main(4), 's')
...
class example_3_21:
    def __init__(self,*args,**kwargs):
        regen = True
        while regen:
            force = c.force(ran.main(500), 'N')
            mass = c.mass(ran.main(25),'kg')
            acceleration = c.acceleration(ran.main(0.75),'mpers2')
            angle = c.angle(ran.main(40),'deg')
...
class example_3_22:
    def __init__(self,*args,**kwargs):
        mass1 = c.mass(ran.main(300),'g')
        mass2 = c.mass(ran.main(500),'g')
        mu = ran.main(0.40)
        acceleration = c.acceleration(ran.main(200), 'cmpers2')
...
class example_3_23:
    def __init__(self,*args,**kwargs):
        mass1 = c.mass(ran.main(7),'kg')
        mass2 = c.mass(ran.main(9),'kg')
...
class example_3_24:
    def __init__(self,*args,**kwargs):
        ...
        while regen:
            mu = ran.main(0.2)
            massA = c.mass(ran.main(25),'kg')
            massB = c.mass(ran.main(15),'kg')
            time = c.time(ran.main(3.0),'s')
...
class schaums_6_1:
    def __init__(self,*args,**kwargs):
        force = c.force( ran.main(75), 'N')
        theta = c.angle( ran.main(28), 'deg')
        distance = c.length ( ran.main(8), 'm')
        
        self.question = f"""A horizontal block is pulled along the ground by a {force.N} force direction {theta.deg} degrees. How much work does force do in pulling the object {distance.m} m?"""
        
        work = c.energy( force.N * math.cos(theta.rad) * distance.m )
        
        self.answer = f"""Work = {work.J} J"""
        
class schaums_6_2:
    def __init__(self,*args,**kwargs):
        theta = c.angle( ran.main(30), 'deg')
        f1 = c.force (ran.main (40), 'N')
        f2 = c.force (ran.main (20), 'N')
        f3 = c.force (ran.main (30), 'N')
        distance  = c.length( ran.main(80), 'cm')
        
        self.question = f"""A block moves up a {theta.deg} degree incline under the action of certain force. F1 is horizontal and of magnitude {f1.N} N. F2 is normal to the plane and of magnitude {f2.N} N. F3 is parallel to the plane and of magnitude {f3.N} N. Determine the work done by each force as the block (and the point of application of each force) moves up {distance.cm} cm up the incline."""
        
        work1 = c.energy (f1.N * math.cos(theta.rad) * distance.m )
        work2 = c.energy (0)
        work3 = c.energy (f3.N * distance.m)
        
        self.answer = f"""Work done by force 1 = {work1.J} J
Work done by force 2 = {work2.J} J
Work done by force 3 = {work3.J} J"""

class schaums_6_3:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(300),'g')
        distance = c.length(ran.main(80),'cm')
        mu = ran.main(0.20)
...
class schaums_6_4:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(3), 'kg')
        distance = c.length(ran.main(40), 'cm')
...
class schaums_6_6:
    def __init__(self,*args,**kwargs):
        ladderLength = c.length(ran.main(3), 'm')
        ladderWeight = c.force(ran.main(200),'N')
        ladderCenterOfGravity = c.length(ran.main(120),'cm')
        topEndWeight = c.force(ran.main(50),'N')
...
class schaums_6_7:
    def __init__(self,*args,**kwargs):
        volume = c.volume( ran.main(600),'L')
        height = c.length( ran.main(20), 'm')
...
class schaums_6_8:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(2), 'kg')
        height = c.length(ran.main(400),'cm')
        ...
        self.answer = f"""Work done by gravity = {work.J} J
Potential energy lost =  - {work.J} J"""


class schaums_6_9:
    def __init__(self,*args,**kwargs):
        force = c.force(ran.main(1.50),'N')
        mass = c.mass(ran.main(0.20), 'kg')
        distance = c.length(ran.main(30),'cm')
...
class schaums_6_10:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(0.50), 'kg')
        velocity1 = c.velocity(ran.main(20),'cmpers')
        velocity2 = c.velocity(0)
        distance = c.length(ran.main(70),'cm')
        ...
        self.answer = f"""Frictional force = {friction.N} N"""
        
class schaums_6_11:
    def __init__(self,*args,**kwargs):
        velocity = c.velocity ( ran.main (15), 'mpers')
        distance = c.length(ran.main(2),'m')
        mass = c.mass (ran.main(90), 'kg')
        ...
        self.answer = f"""Force = {force.kN} kN"""
...
class schaums_6_12:
    def __init__(self,*args,**kwargs):
        ...
        while regen:
            velocity = c.velocity(ran.main(20),'mpers')
            velocitySpecific = c.velocity(ran.main(12), 'mpers')
...
class schaums_6_13:
    def __init__(self,*args,**kwargs):
        ...
        error = False
        while regen:
            mass1 = c.mass(ran.main(800),'g')
            mass2 = c.mass(ran.main(700),'g')
            distance = c.length(ran.main(120),'cm')
...
class schaums_6_16:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(1200),'kg')
        angle = c.angle(ran.main(30),'deg')
        speed = c.velocity(ran.main(12),'mpers')
        distance = c.length(ran.main(100),'m')
        ...
        self.answer = f"""Friction = {friction.kN} kN"""
        
class schaums_6_17:
    def __init__(self,*args,**kwargs):
        regen = True
        while regen:
            length = c.length( ran.main(180), 'cm')
            velocity = c.velocity ( ran.main(400), 'cmpers')
...
class schaums_6_18:
    def __init__(self,*args,**kwargs):
        mass = c.mass ( ran.main(500), 'g')
        angle = c.angle( ran.main(25), 'deg')
        velocity = c.velocity ( ran.main(200), 'cmpers')
        mu = ran.main(0.150)
        ...
        x_set = sym.solveset(equation, x)
        x_list = list(x_set)
        
        distance = c.length(x_list[0])
        
        self.answer = f"""Distance = {distance.m} m"""
        
class schaums_6_19:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(60000), 'kg' )
        percentGrade = c.percentage(random.randint(1,3),'percent')
        force = c.force( ran.main(3.0), 'kN' )
        friction = c.force ( ran.main(4.0), 'kN' )
        velocity1 = c.velocity( ran.main(12), 'mpers' )
        velocity2 = c.velocity( ran.main(9), 'mpers' )
        ...
        self.answer = f"""Distance = {distance.km} km"""
        
class schaums_6_20:
    def __init__(self,*args,**kwargs):
        mass = c.mass( ran.main(1200), 'kg')
        velocity = c.velocity ( ran.main(25), 'mpers')
        time = c.time( ran.main(8.0), 's')
...
class schaums_6_21:
    def __init__(self,*args,**kwargs):
        power = c.power ( ran.main(0.25), 'hp')
        velocity = c.velocity ( ran.main(5.0), 'cmpers')
...
class schaums_6_23:
    def __init__(self,*args,**kwargs):
        distance = c.length( ran.main(12), 'm')
        dischargeRate = c.mass(ran.main(2), 'kg')
        speed = c.velocity(ran.main(3), 'mpers')
...
class schaums_8_1:
    def __init__(self,*args,**kwargs): 
        ...
        mass_bullet = c.mass(ran.main(8, 'int'), 'g')
        mass_wood = c.mass(ran.main(9, 'int'), 'kg')
        velocityprime = c.velocity(ran.main(40, 'int'), 'cmpers')
        ...
        self.answer = f"""Bullet speed before impact = {velocitybullet.kmpers} km/s"""
...
class schaums_8_2:
    def __init__(self,*args,**kwargs): 
        ...
        mass1 = c.mass(ran.main(16,' int'), 'g')
        mass2 = c.mass(ran.main(4, 'int'), 'g')
        mass1velocity = c.velocity(ran.main(30, 'int'), 'cmpers')
        mass2velocity = c.velocity(ran.main(50, 'int'), 'cmpers')
        ...
        self.answer = f"""The velocity of the blocks after collision = {velocityprime.mpers} m/s"""
        
class schaums_8_3:
    def __init__(self,*args,**kwargs): 
        
        mass = c.mass(ran.main(2))
        speed = c.velocity(ran.main(6))
        time = c.time(ran.main(7e-4, 'noround'))
...
class schaums_8_4:
    def __init__(self,*args,**kwargs): 
        regen = True
        while regen:
            mass = c.mass(ran.main(15, 'int'), 'g')
            speedbullet = c.velocity(ran.main(300, 'int'), 'mpers')
            speedbullet2 = c.velocity(speedbullet.mpers - ran.main(210, 'int'), 'mpers')
            thick = c.length(ran.main(2), 'cm')
...
class schaums_8_5:
    def __init__(self,*args,**kwargs): 
        ...
        massnucleus = c.mass(ran.main(3.8e-25, 'noround'))
        massparticle = c.mass(ran.main(6.6e-27, 'noround'))
        speedparticle = c.velocity(ran.main(1.5e7, 'noround'))
        ...
        self.answer = f"""Speed of recoiling nucleus = {speednucleus_after.mpers} m/s"""
        
class schaums_8_6:
    def __init__(self,*args,**kwargs): 
        
        ballmass = c.mass(ran.main(0.25), 'kg')
        ballspeed = c.velocity(ran.main(13), 'mpers')
        ballspeed2 = c.velocity(ran.main(19), 'mpers')
        time = c.time(ran.main(0.010), 's')
...
class schaums_8_8:
    def __init__(self,*args,**kwargs): 
        ...
        bulletmass = c.mass(ran.main(15), 'g')
        blockmass = c.mass(ran.main(3), 'kg')
        height = c.length(ran.main(10), 'cm')
        ...
        self.answer = f"""Bullet initial velocity = {bulletvelocity.kmpers} km/s"""
...
class schaums_8_9:
    def __init__(self,*args,**kwargs): 
        ...
        x1 = c.length(0)
        x2 = c.length(ran.main(30,' int'), 'cm')
        x3 = c.length(ran.main(70, 'int'), 'cm')
        
        mass1 = c.mass(ran.main(200), 'g')
        mass2 = c.mass(ran.main(500), 'g')
        mass3 = c.mass(ran.main(400), 'g')
        ...
        self.answer = f"""The center of mass is on x = {xbar.cm} cm"""
        
class schaums_8_10:
    def __init__(self,*args,**kwargs): 
        
        mass1 = c.mass(ran.main(4))
        mass2 = c.mass(ran.main(7))
        mass3 = c.mass(ran.main(5))
        
        x1 = c.length(0)
        y1 = c.length(ran.main(5))
        x2 = c.length(ran.main(3))
        y2 = c.length(ran.main(8))
        x3 = c.length(ran.main(-3))
        y3 = c.length(ran.main(-6))
        ...
        self.answer = f"""Coordinates of the center of mass = ({xbar.m} , {ybar.m})"""
        
class schaums_8_11:
    def __init__(self,*args,**kwargs): 
        
        speed1y = c.velocity(ran.main(2))
        speed2x = c.velocity(ran.main(3))
        speed1xprime = c.velocity(ran.main(1.2))
        ...
        self.answer = f"""Vx = {speed2xprime.mpers} m/s and Vy = {speed2yprime.mpers} m/s"""
        
class schaums_8_12:
    def __init__(self,*args,**kwargs): 
        
        truckmass = c.mass(ran.main(7500))
        carmass = c.mass(ran.main(1500))
        truckspeed = c.velocity(ran.main(5))
        carspeed = c.velocity(ran.main(20))
        totalmass = c.mass(truckmass.kg + carmass.kg)
        angle = c.angle(ran.main(30, 'int'), 'deg')
        ...
        self.answer = f"""Wreckage speed = {speedprime.mpers} m/s
Wreckage direction = {angle2.deg} degrees"""


class schaums_8_13:
    def __init__(self,*args,**kwargs): 
        
        speed1 = c.velocity(ran.main(0.75))
        speed2 = c.velocity(ran.main(0.43))
        ...
        self.answer = f"""First ball final velocity = {- speed2.mpers} m/s 
Second ball final velocity = {speed1.mpers} m/s"""


class schaums_8_14:
    def __init__(self,*args,**kwargs): 
        
        mass = c.mass(ran.main(1.0))
        mass2 = c.mass(ran.main(2.0))
        speed = c.velocity(ran.main(12))
        speed2 = c.velocity(ran.main(24))
        ...
        set1 = sym.linsolve(equations, x, y)
        
        equations = [equation, equation3]
        set2 = sym.linsolve(equations, x, y)
        
        equations = [equation, equation4]
        set3 = sym.linsolve(equations, x, y)
        
        self.answer = f"""List of velocities: temporary
{set1} , {set2} , {set3}"""

class schaums_8_15:
    def __init__(self,*args,**kwargs): 
        
        factor = ran.main(0.65)
        
        self.question = f"""A ball is dropped from a height h above a tile floor and rebounds to a height of {factor} h. Find the coefficient of restitution between the ball and the floor."""
        
        e = math.sqrt(factor)
        
        self.answer = f"""Coefficient of restitution = {e} """


class schaums_8_16:
    def __init__(self,*args,**kwargs): 
        
        waterspeed = c.velocity(ran.main(80), 'cmpers')
        volume = c.volume(ran.main(30), 'mL')
...
class schaums_8_17:
    def __init__(self,*args,**kwargs): 
        ...
        mass = c.mass(ran.main(1500))
        speed = c.velocity(ran.main(50), 'kmpers')
        ...
        self.answer = f"""Max mass of rocket = {mass.kg} kg"""
...
class example_9_2:
    def __init__(self,*args,**kwargs): 
        length = c.length(ran.main(90), 'cm')
        arcLength = c.length(ran.main(15),'cm')
...
class example_9_3:
    def __init__(self,*args,**kwargs): 
        omega = c.angularVelocity(ran.main(900),'rpm')
        distance = c.length(ran.main(20),'cm')
...
class example_9_4:
    def __init__(self,*args,**kwargs): 
        radius = c.length(ran.main(25),'cm')
        tangentialSpeed = c.velocity(ran.main(5.0),'mpers')
...
class example_9_5:
    def __init__(self,*args,**kwargs): 
        radius = c.length(ran.main(40), 'cm')
        omegaF = c.angularVelocity(ran.main(900),'rpm')
        time = c.time(ran.main(20),'s')
...
class example_9_6:
    def __init__(self,*args,**kwargs): 
        radius = c.length(ran.main(5),'cm')
        omegaI = c.angularVelocity(ran.main(30),'revpers')
        omegaF = c.angularVelocity(ran.main(20),'revpers')
        time = c.time(ran.main(2),'s')
...
class example_9_7:
    def __init__(self,*args,**kwargs): 
        radius = c.length(ran.main(30),'cm')
        velocityF = c.velocity(ran.main(15),'mpers')
        time = c.time(ran.main(8), 's')
...
class example_9_8:
    def __init__(self,*args,**kwargs): 
        omegaI = c.angularVelocity(ran.main(900),'rpm')
        omegaF = c.angularVelocity(ran.main(300),'rpm')
        theta = c.angle(ran.main(50),'rev')
...
class example_9_9:
    def __init__(self,*args,**kwargs): 
        mass = c.mass(ran.main(200), 'g')
        radius = c.length(ran.main(1.20),'m')
        omega = c.angularVelocity(ran.main(3.0), 'revpers')
...
class example_9_11:
    def __init__(self,*args,**kwargs): 
        height = c.length(ran.main(20000), 'm')
...
class example_9_12:
    def __init__(self,*args,**kwargs): 
        length = c.length(ran.main(24), 'cm')
        angle = c.angle(ran.main(30),'deg')
...
# class example_9_13:
    # def __init__(self,*args,**kwargs): 
        # height = c.length(ran.main(25), 'cm')
        # radius = c.length(ran.main(5), 'cm')
        
class example_9_14:
    def __init__(self,*args,**kwargs): 
        mass = c.mass(ran.main(0.90), 'kg')
        radius = c.length(ran.main(2.50), 'm')
        ...
        #b
        equation = sym.Eq(0.5*x**2, 0.5*speedTop.mpers + gravity.mpers2*2*radius.m)
        speedBottom = c.velocity(max(sym.solveset(equation,x,domain = sym.Reals).args[0],sym.solveset(equation,x,domain = sym.Reals).args[1]))
...
class example_9_15:
    def __init__(self,*args,**kwargs): 
        radius = c.length(ran.main(30),'m')
        speed = c.velocity(ran.main(13),'mpers')
...
class example_9_16:
    def __init__(self,*args,**kwargs): 
        radius = c.length(ran.main(150), 'cm')
        mu = ran.main(0.30)
...
class schaums_10_1:
    def __init__(self,*args,**kwargs): 
        ...
        mass = c.mass(ran.main(6.0), 'kg')
        radius = c.length(ran.main(40), 'cm')
        omega = c.angularVelocity(ran.main(300), 'revperm')
...
class schaums_10_2:
    def __init__(self,*args,**kwargs): 
        ...
        mass = c.mass(ran.main(500), 'g')
        radius = c.length(ran.main(7.0), 'cm')
        omega = c.angularVelocity(ran.main(30), 'revpers')
...
class schaums_10_3:
    def __init__(self,*args,**kwargs): 
        ...
        mass = c.mass(ran.main(70), 'kg')
        radius = c.length(ran.main(75), 'cm')
        alpha = c.angularAcceleration(ran.main(4.0), 'revpers2')
...
class schaums_10_4:
    def __init__(self,*args,**kwargs): 
        ...
        force = c.force(ran.main(40), 'N')
        radius = c.length(ran.main(20), 'cm')
        moi = c.momentOfInertia(ran.main(30), 'kgm2')
        time = c.time(ran.main(4.0), 's')
...
class schaums_10_5:
    def __init__(self,*args,**kwargs): 
        mass = c.mass(ran.main(0.9), 'kg')
        radius = c.length(ran.main(8.0), 'cm')
        omega = c.angularVelocity(ran.main(1400), 'revperm')
        time = c.time(ran.main(35), 's')
...
class schaums_10_7:
    def __init__(self,*args,**kwargs):
        moi = c.momentOfInertia(ran.main(3.8), 'kgm2')
        omegai = c.angularVelocity(ran.main(2.0), 'revpers')
        omegaf = c.angularVelocity(omegai.revpers + ran.main(3), 'revpers')
        theta = c.angle(ran.main(6), 'rev')
...
class schaums_10_8:
    def __init__(self,*args,**kwargs): 
        mass = c.mass(ran.main(400), 'g')
        radius = c.length(ran.main(15), 'cm')
        height = c.length(ran.main(2), 'm')
        time = c.time(ran.main(6.5), 's')
        ...
        equation = sym.Eq( height.m, 0.5 * x * time.s**2)
        accel_set = sym.solveset(equation,x)
        accel_list = list(accel_set)
        acceleration = c.acceleration(accel_list[0])
        alpha = c.angularAcceleration(acceleration.mpers2)
        
        equation = sym.Eq(mass.kg * gravity.mpers2 - x, mass.kg * acceleration.mpers2)
        tension_set = sym.solveset(equation, x)
...
class schaums_10_10:
    def __init__(self,*args,**kwargs): 
        moi = c.momentOfInertia(ran.main(1.7), 'kgm2')
        radius2 = c.length(ran.main(20), 'cm')
        radius1 = c.length(radius2.cm + ran.main(30), 'cm')
        mass2 = c.mass(ran.main(1.8))
        mass1 = c.mass(mass2.kg + ran.main(0.2), 'kg')
        ...
        alpha_set = sym.solveset(equation,x)
...
class schaums_10_12:
    def __init__(self,*args,**kwargs): 
        omega = c.angularVelocity(ran.main(20), 'revpers')
        torque = c.torque(ran.main(75), 'Nm')
...
class schaums_10_13:
    def __init__(self,*args,**kwargs): 
        diameter = c.length(ran.main(38), 'cm')
        radius = c.length(diameter.cm /2 , 'cm')
        omega = c.angularVelocity(ran.main(1200), 'revperm')
        tension_slack = c.force(ran.main(130))
        tension_tight = c.force(tension_slack.N + ran.main(470))
...
class schaums_10_14:
    def __init__(self,*args,**kwargs): 
        power = c.power(ran.main(0.75), 'hp')
        time = c.time(ran.main(8), 's')
        moi = c.momentOfInertia(ran.main(2.0), 'kgm2')
...
class schaums_10_15:
    def __init__(self,*args,**kwargs): 
        ...
        height_set = sym.solveset(equation, x)
...
class schaums_10_17:
    def __init__(self,*args,**kwargs): 
        velocity = c.velocity(ran.main(80), 'cmpers')
        height = c.length(ran.main(18), 'cm')
        ...
        velocity2_set = sym.solveset(equation, x)
...
class schaums_10_18:
    def __init__(self,*args,**kwargs): 
        mass1 = c.mass(ran.main(2))
        mass2 = c.mass(ran.main(3))
        mass3 = c.mass(ran.main(4))
        mass4 = c.mass(ran.main(5))
        width = c.length(ran.main(120), 'cm')
        length = c.length(width.cm + ran.main(130), 'cm')
...
class schaums_10_19:
    def __init__(self,*args,**kwargs): 
        mass = c.mass(ran.main(6), 'kg')
        diameter = c.length(ran.main(80), 'cm')
        radius = c.length(diameter.cm/2, 'cm')
        height = c.length((radius.cm/2) + ran.main(2), 'cm')
...
class schaums_10_20:
    def __init__(self,*args,**kwargs): 
        diameter = c.length(ran.main(1.8), 'm')
        radius = c.length(diameter.m/2, 'm')
        weight = c.force(ran.main(10), 'kN')
        velocity = c.velocity(ran.main(4.0), 'mpers')
        distance = c.length(ran.main(3), 'm')
...
class schaums_10_22:
    def __init__(self,*args,**kwargs): 
        omega1 = c.angularVelocity(ran.main(0.25), 'revpers')
        omega2 = c.angularVelocity(omega1.revpers + ran.main(0.55), 'revpers')
...
class schaums_10_25:
    def __init__(self,*args,**kwargs): 
        moi = c.momentOfInertia(ran.main(0.0150, 'noround'))
        omega2 = c.angularVelocity(ran.main(2), 'revpers')
        omega = c.angularVelocity(omega2.revpers + ran.main(1), 'revpers')
        radius = c.length(ran.main(20), 'cm')
...
class schaums_11_2:
    def __init__ (self,*args, **kwargs):
        vibrations = ran.main(12,'int')
        time = c.time(ran.main(40))
...
class schaums_11_3:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(400),'g')
        ydistance = c.length(ran.main(35),'cm')
        additionalMass = c.mass(ran.main(400),'g')
...
class schaums_11_4:
    def __init__(self, *args,**kwargs):
        mass = c.mass(ran.main(200),'g')
        k = c.springConstant(ran.main(7))
        maxDisplacement = c.length(ran.main(5),'cm')
...
class schaums_11_5:
    def __init__(self, *args, **kwargs):
        mass = c.mass(ran.main(50,'int'),'g')
        A = c.length(ran.main(12,'int'),'cm')
        period = c.time(ran.main(1.70, round=2), 's')
...
class schaums_11_6:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(50),'g')
        massAdd = c.mass(ran.main(20),'g')
        xAdd = c.length(ran.main(7),'cm')
        gravity = c.acceleration(9.81,'mpers2')
...
class schaums_11_7:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(2),'kg')
        force = c.force(ran.main(8),'N')
        A = c.length(ran.main(20),'cm')
...
class schaums_11_11:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(20),'kg')
        kOneSpring = c.springConstant(ran.main(30),'Npercm')
...
class schaums_11_13:
    def __init__(self,*args,**kwargs):
        L = c.length(ran.main(150.3), 'cm')
        cycles = ran.main(100)
        time100Cycles = c.time(ran.main(246.7),'s')
...
class schaums_11_14:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(200),'g')
        displacement = c.length(ran.main(15),'cm')
        k = c.springConstant(ran.main(400),'Nperm')
...
class schaums_11_17:
    def __init__(self,*args,**kwargs):
        mass = c.mass(ran.main(17),'g')
        A = c.length(ran.main(0.75),'cm')
        omega = c.angularVelocity(ran.main(63),'radpers')
        
        timeSpecific = c.time(ran.main(0.020),'s')
...
class schaums_13_1:
    def __init__(self,*args,**kwargs): 
        mass = c.mass(ran.main(80), 'kg')
        length = c.length(ran.main(2), 'm')
        area = c.area(ran.main(25), 'cm2')
...
class schaums_13_2:
    def __init__(self,*args,**kwargs): 
        patm = 101325
        width = c.length(ran.main(40), 'cm')
        length = c.length(width.cm + ran.main(40), 'cm')
...
class schaums_13_5:
    def __init__(self,*args,**kwargs): 
        ...
        pressure = c.pressure(ran.main(270), 'kPa')
...
class schaums_13_6:
    def __init__(self,*args,**kwargs): 
        area = c.area(ran.main(8), 'km2')
        depth2 = c.length(ran.main(3), 'm')
        depth = c.length(depth2.m + ran.main(9), 'm')
        density_water = c.density(1000, 'kgperm3')
...
class schaums_13_8:
    def __init__(self,*args,**kwargs): 
        area = c.area(ran.main(200), 'cm2')
        area2 = c.area(ran.main(5), 'cm2')
        force2 = c.force(ran.main(250), 'N')
...
class schaums_13_9:
    def __init__(self,*args,**kwargs): 
        ...
        area2 = c.area(ran.main(25), 'cm2')
        density_oil = c.density(0.78, 'gpercm3')
        height = c.length(ran.main(8), 'm')
        ...
        force_set = sym.solveset(equation, x)
...
class schaums_13_10:
    def __init__(self,*args,**kwargs): 
        ...
        pressure_limit = c.pressure(ran.main(350), 'kPa')
...
class schaums_13_11:
    def __init__(self,*args,**kwargs): 
        height_oil = c.length(ran.main(2), 'cm')
        height_water = c.length(ran.main(8), 'cm')
...
class schaums_13_12:
    def __init__(self,*args,**kwargs): 
        height2 = c.length(ran.main(31), 'cm')
        height = c.length(height2.cm + ran.main(9), 'cm')
        density_water = c.density(1000, 'kgperm3')
...
class schaums_13_13:
    def __init__(self,*args,**kwargs): 
        ...
        pressure_tank_set = sym.solveset(equation, x)
...
class schaums_13_15:
    def __init__(self,*args,**kwargs): 
        mass2 = c.mass(ran.main(73), 'g')
        mass = c.mass(mass2.g + ran.main(13), 'g')
        density_water = c.density(1000, 'kgperm3')
...
class schaums_13_16:
    def __init__(self,*args,**kwargs): 
        ...
        density_aluminum = c.density(2700, 'kgperm3')
        mass2 = c.mass(ran.main(45), 'g')
        mass = c.mass(mass2.g + ran.main(22), 'g')
...
class schaums_13_17:
    def __init__(self,*args,**kwargs): 
        mass3 = c.mass(ran.main(0.70), 'g')
        mass2 = c.mass(mass3.g + ran.main(0.8), 'g')
        mass = c.mass(mass2.g + ran.main(1), 'g')
        density_water = c.density(1000, 'kgperm3')
...
class schaums_13_19:
    def __init__(self,*args,**kwargs): 
        ...
        while regen:
            mass = c.mass(ran.main(60), 'kg')
            width = c.length(ran.main(0.80), 'm')
            length = c.length(width.m + ran.main(0.2), 'm')
            height = c.length(ran.main(0.5), 'm')
            depth = c.length(ran.main(30), 'cm')
            density_water = c.density(1000, 'kgperm3')
            ...
            height_sink_set = sym.solveset(equation, x)
        ...
        force_b_set = sym.solveset(equation, x)
...
class schaums_13_20:
    def __init__(self,*args,**kwargs): 
        ...
        floating = c.percentage(ran.main(20), 'percent')
        ...
        volume_foam_set = sym.solveset(equation, x)
...
class schaums_13_21:
    def __init__(self,*args,**kwargs):
        weight = c.force(ran.main(2.30), 'N')
        weight2 = c.force(weight.N + ran.main(0.45), 'N')
        density_water = c.density(1000, 'kgperm3')
...
class schaums_13_22:
    def __init__(self,*args,**kwargs): 
        ...
        density_water = c.density(1000, 'kgperm3')
        while regen:
            mass2 = c.mass(ran.main(36.22), 'g')
            mass = c.mass(mass2.g + ran.main(2.03), 'g')
...
class schaums_18_5:
    def __init__(self,*args,**kwargs): 
        ...
        tfinal_set = sym.solveset(mcoffee * (x - tcoffee) + mmilk*(x - tmilk),x)
...
class schaums_18_7:
    def __init__(self,*args,**kwargs): 
        ...
        tf = sym.solveset(sym.Eq(cal*mal*(x - tal) + ccu*mcu*(x-tcu) + coil*moil*(x - toil),0) , x).args[0]
        tf = sym.N(tf)
        self.answer = """{tf:g}°C""".format(tf = tf)
        solution = """sum(dQn) = 0
        dQ = mc dT"""
...
class schaums_18_8:
    def __init__(self,*args,**kwargs): 
        ...
        mcal = ran.hundred(1500)
        mw = ran.hundred(2000)
        t1 = ran.ten(20)
        t2 = t1 + random.randint(5,20)
        dT = t2 - t1
        Qcarbon = sym.solveset(x + ccu*mcal*dT + cwater*mw*dT,x).args[0]
        Qcarbon = sym.N(Qcarbon)
...
class schaums_18_9:
    def __init__(self,*args,**kwargs): 
        ...
        while retry == True:
            ...
            cwater = SPECIFIC_HEAT_WATER_CALGC
            tf = sym.solveset(mice*Hice + cwater*mice*(x - 0) + cwater*mwater*(x - twater),x).args[0]
            tf = sym.N(tf)
            if tf > 0:
                retry = False
...
class schaums_18_11:
    def __init__(self,*args,**kwargs): 
        ...
        retry = True
        while retry: 
            mice = sym.solveset(mal*cal*(0 - ti) + Lfice*x,x).args[0]
            mice = sym.N(mice)
...
class schaums_18_12:
    def __init__(self,*args,**kwargs): 
        ...
        tf = sym.solveset(mwater2*cwater*(x - twater2) + mice*Lice + (mwater1 + mice)*cwater*x + mcal*cwater*x,x).args[0]
        tf = sym.N(tf)
...
class schaums_18_13:
    def __init__(self,*args,**kwargs): 
        ...
        m = sym.solveset(x*Lv - (P*t*MIN_SEC), x).args[0]
        m = sym.N(m)
...
class schaums_19_3:
    def __init__(self,*args,**kwargs): 
        ...
        tjunc = sym.solveset((kt1*(temp1 - x)) - (kt2*(x - temp2)),x,domain=sym.Reals).args[0]
        tjunc = sym.N(tjunc)
...
class schaums_20_4:
    def __init__(self,*args,**kwargs): 
        spring_const = ran.r(500)
        mass_block = ran.r(400)
        mass_water = ran.r(900)
        specific_heat_block = ran.r(450)
        dx = ran.r(15)
        PE = (1/2)* spring_const * (dx*CENTI)**2
        dT = sym.solveset(mass_block*GRAMS*specific_heat_block*x + mass_water*GRAMS*SPECIFIC_HEAT_WATER_JKGK*x - PE,x,domain = sym.Reals).args[0]
        dT = sym.N(dT)
        self.answer = f'{dT} K'
        solution = f"""
PE = (1/2)* spring_const * (dx*CENTI)**2
...
class schaums_20_12:
    def __init__(self,*args,**kwargs): 
        volume_initial = ran.r(3)
        volume_final = volume_initial + ran.r(21)
        pressure_initial = ran.r(20)
...
class example_22_2:
    def __init__(self,*args,**kwargs):
        wavelength = c.length( ran.main(18.0),'cm')
        frequency = c.frequency ( ran.main(1900),'Hz')
...
class example_22_3:
    def __init__(self,*args,**kwargs):
        ...
        mass = c.mass(ran.main(1.45),'g')
        frequency = c.frequency( ran.main(120), 'Hz')
        wavelength = c.length( ran.main(60.0), 'cm')
...
class example_22_4:
    def __init__(self,*args,**kwargs):
        length = c.length( ran.main(20),'m')
        mass = c.mass (ran.main(5),'kg')
        frequency = c.frequency ( ran.main(7.0), 'Hz')
...
# class example_22_5:
    # def __init__(self,*args,**kwargs):
        # tension = c.force(ran.main(88),'N')
        # length = c.length(ran.main(50.0),'cm')
        # mass = c.mass(ran.main(0.50),'g')
...
class schaums_24_1:
    def __init__(self,*args,**kwargs): 
        distance = c.length(ran.main(1.5))
        force = c.force(ran.main(2))
...
class schaums_24_3:
    def __init__(self,*args,**kwargs): 
        ...
        distance = c.length( ran.main(3), 'nm')
...
class schaums_24_4:
    def __init__(self,*args,**kwargs):
        distance = c.length(ran.main(5.3) * 1e-11)
...
class serway_7_1:
    def __init__(self,*args,**kwargs): 
        ...
        force1 = c.force(ran.main(50))
        angle1 = c.angle(ran.main(30), 'degrees')
        displacement1 = c.length(ran.main(3))
        ...
        self.answer = f"""Work done = {work1.J} J"""
        
class serway_7_3:
    def __init__(self,*args,**kwargs): 
        
        deltar = vectors.vector(ran.main(2), ran.main(3),0, '2dim')
        force = vectors.vector(ran.main(5), ran.main(2),0, '2dim')
        ...
        self.answer = f"""Work done = {work.J} J"""
        
class serway_7_5:
    def __init__(self,*args,**kwargs): 
        
        mass = c.mass(ran.main(550), 'g')
        displacement = c.length(ran.main(2), 'cm')
        ...
        self.answer = f"""Force constant of spring = {k.Nperm} Nperm
Work done by the spring on the object = {work.J} J"""

class serway_7_6:
    def __init__(self,*args,**kwargs): 
        
        mass = c.mass(ran.main(6))
        force = c.force(ran.main(12))
        disp = c.length(ran.main(3))
        ...
        self.answer = f"""Velocity : {velocityf.mpers} m/s"""
        
        
class serway_8_3:
    def __init__(self,*args,**kwargs): 
        mass = c.mass(ran.main(35), 'g')
        ya = c.length(ran.main(-120), 'cm')
        yc = c.length(ran.main(20), 'm')
        ...
        self.answer = f"""Spring constant = {k.Nperm} N/m
Velocity at B = {velocityb.mpers} m/s"""
...
class serway_8_4:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Speed of the block = {velocityfinal.mpers} m/s
Angle that gives largest possible speed = {theta.degrees} degrees."""

class serway_8_6:
    def __init__(self,*args,**kwargs): 
        regen = True
        while regen:
            mass = c.mass(ran.main(1.6))
            k = c.springConstant(ran.main(1000))
            disp = c.length(ran.main(2), 'cm')
            friction = c.force(ran.main(4))
        ...
        self.answer = f"""Speed at situation A = {velocityf.mpers} m/s
Speed at situation B = {velocityf2.mpers} m/s"""

class serway_8_7:
    def __init__(self,*args,**kwargs): 
        
        mass = c.mass(ran.main(3))
        length = c.length(ran.main(1))
        angle = c.angle(ran.main(30), 'degrees')
        friction = c.force(ran.main(5))
        ...
        self.answer = f"""Speed of the crate at the bottom of the ramp = {velocityf.mpers} m/s
Distance the crate slides on the horizontal floor = {distance.m} m"""

class serway_8_8:
    def __init__(self,*args,**kwargs): 
        
        mass = c.mass(ran.main(800), 'g')
        va = c.velocity(ran.main(1.2))
        k = c.springConstant(ran.main(50), 'Nperm')
        mu = ran.main(0.5)
        ...
        self.answer =f"""Maximum compression of the spring after collision = {xmax.m} m
Compression of the spring in the presence of friction = {x2.m} m"""

class serway_8_11:
    def __init__(self,*args,**kwargs): 
        
        elevatormass = c.mass(ran.main(1600), 'kg')
        loadmass = c.mass(ran.main(200), 'kg')
        friction = c.force(ran.main(4000), 'N')
        velocity = c.velocity(ran.main(3), 'mpers')
        accel = c.acceleration(ran.main(1),'mpers2')
        ...
        self.answer = f"""Power at situation A = {power.W} W
Power at situation B = {power2.W}v W"""
...
class serway_36_3:
    def __init__(self,*args,**kwargs): 
        ...
        do_list = [25, 10, 5]
        do = c.length(ran.main(do_list[temp]), 'cm')
        f = c.length(ran.main(10), 'cm')
        ...
        di_set = sym.solveset(equation, x)
        #print(di_set)
        di_list = list(di_set)
...
class serway_36_4:
    def __init__(self,*args,**kwargs): 
        ...
        do = c.length(ran.main(10))
        f = c.length(ran.main(-0.6))
...
class serway_36_6:
    def __init__(self,*args,**kwargs): 
        regen = True
        while regen:
            radius = c.length(ran.main(3), 'cm')
            nplastic = 1.50
            nair = 1.0
            do = c.length(ran.main(2), 'cm')
