...
class singer_104:
    def __init__(self,*args,**kwargs): 
        ...
        equation = sym.Eq(load.N, stressLimit.Pa * (math.pi/4) * (x**2 - diameterInside.m**2))
        ...
        self.answer = f"""Outside Diameter = {diameterOutside.mm} mm"""
...
class singer_105:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Area of bronze cable = {areaBronze.mm2} mm2
Area of steel cable = {areaSteel.mm2} mm2"""
...
class singer_107:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Stress (steel) = {stressSteel.ksi} ksi
Stress (aluminum) = {stressAluminum.ksi} ksi
Stress (bronze) = {stressBronze.ksi} ksi"""
...
class singer_108:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Safe allowable P = {pMin.kN} kN"""
...
class singer_109:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Safe load = {safeWeight.kips} kips"""
...
class singer_110:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Safe Load = {safeForce.lb} lb"""
...
class singer_116:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Max plate thickness for a hole {diameter.inch} inches in diameter  = {thicknessAsk.inch} inches
Min hole diameter for a plate of thickness {thickness.inch} inch = {diameterAsk.inch} inches"""
...
class singer_117:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Diameter = {diameter.mm} mm"""
...
class singer_125:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Plate Thickness = {thickness.mm} mm
Largest Tensile Stress on Plate = {stressPlateMax.MPa} MPa"""
...
class singer_126:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Safe Load = {safeLoad.kips} kips"""
...
class singer_127:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Diameter of bolt = {diameter.inch} inches
Thickness of yoke = {thickness.inch} inches"""
...
class singer_133:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Tangential Stress = {tangential.MPa} MPa
Longitudinal Stress = {longitudinal.MPa} MPa
Internal Pressure at internal stress of {stress.MPa} MPa = {pressure.MPa} Mpa"""
...
class singer_134:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Pressure = {pressure.psi} psi"""
...
class singer_135:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Thickness = {thickness.inch} inches"""
...
class singer_136:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Safe pressure = {safePressure.MPa} MPa"""
...
class singer_138:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Diameter = {diameterSafe.inch} inches"""
...
class singer_141:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Longitudinal Stress = {longStress.ksi} ksi
Circumferential Stress = {circumStress.ksi} ksi"""
...
class singer_142:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Number of bolts required = {numberBolts} bolts
Circumferential Stress = {circumStress.MPa} MPa"""
...
class singer_206:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Total Elongation = {deformation.mm} mm"""
...
class singer_207:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer =f"""Diamter = {diameter.inch} inches"""
...
class singer_208:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Torque = {torque.kNm} kNm"""
...
class singer_209:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Deformation = {deformation.inch} inches"""
...
class singer_211:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Largest possible value of P = {force.kN} kN"""
...
class singer_223:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Load in the x - direction that has the same deformation as the original loading = {xforce2.kips} kips (tension)"""
...
class singer_225:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Change in diameter = {deltaDiameter.mm} mm"""
...
class singer_226:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Tangential Stress = {xstress.psi} psi"""
...
class singer_227:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Tangential Stress = {xstress.MPa} MPa"""
...
class singer_228:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Longitudinal stress = {lstress.psi} psi
Tangential stress = {tstress.psi} psi"""
...
class singer_233:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Load = {force.kN} kN"""
...
class singer_234:
    def __init__(self,*args,**kwargs): 
        ...
        self.answer = f"""Area of steel = {steelarea.mm2} mm^2"""
